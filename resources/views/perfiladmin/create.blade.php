        ...
        @if (auth()->check())
            ...
            <li class="menuu">
                <p class="navv d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                    ...
                    <img src="/img/usuario.png" alt="" width="45" height="45" class="rounded-circle me-2">
    ...
    <section class="home-section">
        <article class="caja ">
            <section class="formulario">
                <br>
                <div class="imagen">
                    <img class="imgRedonda2" src="/img/adm.jpg" alt="">
                </div>
                <hr>
                <br>
                <br>
                ...
                <div class="row mb-5 justify-content-evenly">
                    <div class="col-5 ">
                        <div class="form-outline">
                            ...
                            <input class="form-control" value="{{ auth()->user()->email }}" name="email_id" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-5 justify-content-evenly">
                    <div class="col-5">
                        <div class="form-outline">
                            ...
                            <input type="text" class="form-control"
                                value="{{ auth()->user()->nombres_y_apellidos }}" name="nombres_y_apellidos_id" />
                    ...
                    <div class="col-5">
                        <div class="form-outline">
                            ...
                            <input type="number" id="Cedula" class="form-control" name="cedula_id"
